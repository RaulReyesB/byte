...
const emailRegister = async (userData, personaData) => {
  const { name, correoElectronico, token } = userData;
                  ...
                  <td style="padding: 30px; background-color: #ffffff;">
                    ...
                    <p style="margin: 0;">
                      Bienvenido a Byte Bus, tu destino de confianza para viajes cómodos y seguros. Estamos emocionados de tenerte a bordo y queremos agradecerte por elegirnos para tus viajes., <a href="www.capu.com.mx"
                        style="color: #e50d70; text-decoration: underline;">${name}</a>, nos esforzamos por brindarte la mejor experiencia de viaje posible. Ya sea que estés viajando por negocios, placer o cualquier otra razón, estamos aquí para hacer que tu viaje sea placentero y sin complicaciones.
                    </p>
                  </td>
                </tr>
                <tr>
...
const correoRestaurarContrasena = async (userData) => {
  ...
  <section class="width:100%;">
      ...
      <p>Please follow the reset password link below: <a target="_blank" href="http://${process.env.SERVER_HOST}:${process.env.SERVER_PORT}/user/cambiar-contrasena/${tokenPassword}"> Here to Change your Password.</a></p>
